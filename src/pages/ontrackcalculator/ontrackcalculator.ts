 ...
 function Calculate(timeIn, standard)
 {
   ...
   let race = document.getElementById("race") as HTMLInputElement
      ...
      else if (Female == true && Male == false)
      {
        ...
        alert("Incorrect gender selection, you must select either Male or Female.")
        return
      }
    ...
    */
    function FemaleEvents()
    {
      ...
      || standard.value == "Westerns" || standard.value == "CSC" || standard.value == "Trials")){
      ...
      else if (Female == true && (age >= 13 || age <= 17) && standard.value == "CJC"){
        Names = ["FiftyFree", "OneFree", "TwoFree", "FourFree", "EightFree", "Mile", 
        "OneBack", "TwoBack", "OneBreast", "TwoBreast", "OneFly", "TwoFly", "TwoMedley", "FourMedley"];
      }
    ...
    function FemaleTimes()
    {
      ...
      if (Female != true || Male == true)
      {
      ...
      else if(standard.value == "CSC"){
        Times = [FiftyFree = 27.15, OneFree = 58.94, TwoFree = 127.57, FourFree = 271.63, EightFree = 558.86,
        Mile = 1087.87, FiftyBack = 30.86, OneBack = 65.55, TwoBack = 144.03, FiftyBreast = 34.26, OneBreast = 74.46, TwoBreast = 162.05,
        FiftyFly = 28.78, OneFly = 63.81, TwoFly = 142.01, TwoMedley = 144.40, FourMedley = 306.78];
      }
      else if (standard.value == "Trials"){
        Times = [FiftyFree = 26.87, OneFree = 57.45, TwoFree = 124.66, FourFree = 265.15, EightFree = 551.99,
        Mile = 1081.82, FiftyBack = 30.53, OneBack = 64.51, TwoBack = 139.60, FiftyBreast = 33.82, OneBreast = 73.10,
        TwoBreast = 158.35, FiftyFly = 28.31, OneFly = 62.63, TwoFly = 141.51, TwoMedley = 142.40, FourMedley = 303.68];
      }
      else if (standard.value == "OnTrack"){
        if (age < 13 || age > 21){
          console.log("This is not a valid age grouping for this calculator")
        }
        else if(age == 13)
        ...
        {
          Times = [OneFree = 57.18, TwoFree = 122.61, FourFree = 257.31, EightFree = 527.15,
          Mile = 1036.55, OneBack = 63.36, TwoBack = 134.83, OneBreast = 70.10, TwoBreast = 152.62,
          OneFly = 61.31, TwoFly = 134.96, TwoMedley = 138.31, FourMedley = 286.98];
        }
        else if (age == 16){  
          Times = [OneFree = 56.34, TwoFree = 120.69, FourFree = 253.75, EightFree = 519.15, Mile = 1017.14,
          OneBack = 62.41, TwoBack = 132.56, OneBreast = 69.00, TwoBreast = 150.29, OneFly = 60.31,
          TwoFly = 132.64, TwoMedley = 136.21, FourMedley = 282.59];         
        }
        else if (age == 17)
        {
          Times = [FiftyFree = 25.69, OneFree = 55.62, TwoFree = 119.07, FourFree = 250.76, EightFree = 513.73,
          Mile = 1002.04, OneBack = 61.59, TwoBack = 130.68, OneBreast = 68.04, TwoBreast = 148.29, OneFly = 59.46,
          TwoFly = 130.73, TwoMedley = 134.45, FourMedley = 278.91];
        }
        else if (age == 18)
        {
          Times = [FiftyFree = 25.43, OneFree = 55.01, TwoFree = 117.74, FourFree = 248.34,
          OneBack = 60.89, OneBreast = 67.22, TwoBreast = 146.58, OneFly = 58.74, TwoFly = 129.21,
          TwoMedley = 133.01];
        }
        else if (age == 19)
        {
      ...
      else if(standard.value == "A"){
        if (age <= 11 && course.value == "SCM")
        {
        ...
        else if (age <= 11 && course.value == "LCM")
        {
        ...
        else if (age == 12 && course.value == "SCM")
        {
        ...
        else if (age == 12 && course.value == "LCM")
        {
        ...
        else if (age == 13 && course.value == "LCM")
        {
        ...
        else if (age == 14 && course.value == "LCM")
        {
        ...
        else if (age == 15 && course.value == "LCM")
        {
        ...
        else if (age == 15 && course.value == "SCM")
        {
        ...
        else if (age >= 16 && course.value == "SCM")
        {
        ...
        else if (age >= 16 && course.value == "LCM")
        {
        ...
        else if (age == 13 && course.value == "SCM")
        {
      ...
      else if (standard.value == "Westerns"){
        console.log("I'm in here assigning values")
        if (age <= 13){
          Times = [FiftyFree = 29.12, OneFree = 63.52, TwoFree = 138.13, FourFree = 292.52,
           EightFree = 602.37, Mile = 1173.96, FiftyBack = 32.40, OneBack = 72.06, TwoBack = 155.42,
           FiftyBreast = 35.97, OneBreast = 81.97, TwoBreast = 177.09, FiftyFly = 30.02, 
           OneFly = 70.10, TwoFly = 159.79, TwoMedley = 156.78, FourMedley = 333.78]
        }
        else if (age == 14){
          Times = [FiftyFree = 28.55, OneFree = 61.90, TwoFree = 134.59, FourFree = 486.04, EightFree = 593.36, 
            Mile = 1146.47, FiftyBack = 32.40, OneBack = 70.02, TwoBack = 151.43, FiftyBreast = 35.97, OneBreast = 79.67, TwoBreast = 172.10,
            FiftyFly = 30.22, OneFly = 68.08, TwoFly = 153.71, TwoMedley = 152.84, FourMedley = 325.67];
        }
        else if (age == 15){
          Times = [FiftyFree = 28.37, OneFree = 61.37, TwoFree = 132.99, FourFree = 282.91, EightFree = 584.07,
            Mile = 1137.31, FiftyBack = 32.40, OneBack = 69.15, TwoBack = 149.57, FiftyBreast = 35.97, OneBreast = 79.11, TwoBreast = 171.13,
            FiftyFly = 30.22, OneFly = 67.21, TwoFly = 152.45, TwoMedley = 151.19, FourMedley = 321.35];
        }
        else if (age >= 16){
          Times = [FiftyFree = 27.84, OneFree = 60.12, TwoFree = 130.12, FourFree = 277.06, EightFree = 572.66,
            Mile = 1113.38, FiftyBack = 32.40, OneBack = 67.29, TwoBack = 145.83, FiftyBreast = 35.97, OneBreast = 77.30,
            TwoBreast = 166.06, FiftyFly = 30.22, OneFly = 65.64, TwoFly = 147.29, TwoMedley = 147.80, FourMedley = 314.60];
        }
      }
      else if (standard.value == "CJC"){
        if (age <= 13){
          Times = [FiftyFree = 28.55, OneFree = 62.27, TwoFree = 135.42, FourFree = 286.78, 
            EightFree = 590.56, Mile = 1150.94, OneBack = 70.65, TwoBack = 152.37, OneBreast = 80.36,
            TwoBreast = 173.62, OneFly = 68.73, TwoFly = 156.66, TwoMedley = 253.71, FourMedley = 327.24];
        }
        else if(age == 14){
          Times = [FiftyFree = 27.99, OneFree = 60.69, TwoFree = 131.95, FourFree = 280.43, EightFree = 581.73,
            Mile = 1123.99, OneBack = 68.65, TwoBack = 148.46, OneBreast = 78.11, TwoBreast = 168.73, OneFly = 66.75, TwoFly = 150.70, TwoMedley = 149.84, FourMedley = 319.28];
        }
        else if(age == 15){
          Times = [FiftyFree = 27.81, OneFree = 60.17, TwoFree = 130.38, FourFree = 277.36, EightFree = 572.62,
            Mile = 1115.01, OneBack = 67.79, TwoBack = 146.64, OneBreast = 77.56, TwoBreast = 177.77, OneFly = 65.89, TwoFly = 149.46, TwoMedley = 148.23,
            FourMedley = 315.05];
        }
        else if (age == 16 || age == 17){
          Times = [FiftyFree = 27.29, OneFree = 58.94, TwoFree = 127.57, FourFree = 271.63, EightFree = 561.43,
            Mile = 1091.55, OneBack = 65.97, TwoBack = 142.97, OneBreast = 75.78, TwoBreast = 182.80,
            OneFly = 64.35, TwoFly = 144.40, TwoMedley = 144.90, FourMedley = 308.43];
        }
      }
      return Times
    }
    /* a function that assigns events to be inserted into the time standards array for a male at a certain age category
    for a specific time standard based on user selection */
    function MaleEvents()
    {
      let swimmerAge = document.getElementById("Age") as HTMLInputElement
      age = parseInt(swimmerAge.value)
      ...
      || standard.value == "Westerns" || standard.value == "Trials" || standard.value == "CSC"))
      {
      ...
      else if (Male == true && (age >= 14 || age <= 18) && standard.value == "CJC"){
        Names = ["FiftyFree", "OneFree", "TwoFree", "FourFree", "EightFree", "Mile", 
        "OneBack", "TwoBack", "OneBreast", "TwoBreast", "OneFly", "TwoFly", "TwoMedley", "FourMedley"];
      }
    ...
    /* a function that assigns the time standards for a Male at a given age category to the Array of races that are applicable to 
    that swimmer */
    function MaleTimes() 
    {
      let swimmerAge = document.getElementById("Age") as HTMLInputElement
      ...
      if(standard.value == "A"){
        ...
        else if (age == 14 && course.value == "SCM"){
        ...
        else if(age >= 17 && course.value == "SCM"){
        ...
        if (age == 15)
        {         
          return Times = [TwoFree = 113.74, FourFree = 242.71, EightFree = 500.80,
          Mile = 985.16, TwoBack = 125.27, TwoBreast = 143.80, FourMedley = 278.64]        
        }
        else if (age == 16)
        { 
          return Times = [OneFree = 51.72, TwoFree = 111.68, FourFree = 237.78, EightFree = 491.33,
          Mile = 963.20, OneBack = 57.59, TwoBack = 122.84, TwoBreast = 139.78,
          OneFly = 56.19, TwoFly = 125.10, TwoMedley = 126.77, FourMedley = 271.64]           
        }
        else if (age == 17)
        {
          return Times = [OneFree = 50.74, TwoFree = 109.90, FourFree = 233.62, EightFree = 483.97,
          Mile = 944.8, OneBack = 56.44, TwoBack = 120.76, OneBreast = 64.38, TwoBreast = 136.39,
          OneFly = 54.87, TwoFly = 122.17, TwoMedley = 124.47, FourMedley = 265.91]
        }
        else if (age == 18)
        {
          return Times = [FiftyFree = 23.18, OneFree = 49.89, TwoFree = 108.40, FourFree = 230.20, EightFree = 478.31,
          Mile = 929.77, OneBack = 55.46, TwoBack = 119.01, OneBreast = 63.02, TwoBreast = 133.57,  OneFly = 53.75,
          TwoFly = 119.84, TwoMedley = 122.56, FourMedley = 261.36]
        }
        else if (age == 19)
        {
          return Times = [FiftyFree = 22.84, OneFree = 49.17, TwoFree = 107.15, FourFree = 227.43,
          EightFree = 474.31, Mile = 917.75, OneBack = 54.65, TwoBack = 117.58, OneBreast = 61.90,
          TwoBreast = 131.26, OneFly = 52.83, TwoFly = 118.04, TwoMedley = 121.00, FourMedley = 257.88]
        }
        else if (age == 20)
        { 
          return Times = [FiftyFree = 22.55, OneFree = 48.58, OneBack = 53.99,
          OneBreast = 60.98, OneFly = 52.08, TwoFly = 116.72, TwoMedley = 119.77]
        }
        else if (age == 21)
        { 
          return Times = [FiftyFree = 22.30, OneBreast = 60.26]
        }
        else if (age == 22)
        {
          return Times = [FiftyFree = 22.10]
        }
      }
    }
  }  
